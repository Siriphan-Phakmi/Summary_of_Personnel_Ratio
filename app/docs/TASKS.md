...
### รายการที่แก้ไขไป (อัปเดตล่าสุด 2024-07-30)
- [x] **ปรับปรุงการแสดงผลกราฟวงกลมจำนวนเตียงในหน้า Dashboard:**
  - [x] เพิ่มข้อความ "วันนี้ยังไม่ได้ลงข้อมูล" เมื่อไม่มีข้อมูลจำนวนเตียง
  - [x] ปรับปรุง UI ของ Tooltip ให้แสดงข้อความแนะนำให้ผู้ใช้กรอกข้อมูล
  - [x] ปรับปรุง Legend ให้แสดงข้อความแนะนำเมื่อไม่มีข้อมูล
  - [x] เพิ่มสีที่แตกต่างกันชัดเจนสำหรับสถานะเตียงว่างและไม่ว่าง
  - [x] ปรับปรุงป้ายกำกับในกราฟวงกลมให้มีพื้นหลังและขอบเพื่อให้เห็นชัดเจน

- [x] **ปรับปรุงการแสดงผลแนวโน้มผู้ป่วยในหน้า Dashboard:**
  - [x] เพิ่มไอคอนกราฟในหัวข้อแนวโน้มผู้ป่วยเพื่อให้น่าสนใจมากขึ้น
  - [x] แสดงชื่อแผนกที่เลือกด้วยสีที่แตกต่างกัน
  - [x] ปรับปรุงคำอธิบายการใช้งานให้ชัดเจนขึ้น

- [x] **เพิ่ม useEffect เพื่อคำนวณข้อมูลจำนวนเตียงใหม่:**
  - [x] ปรับปรุง useEffect ให้ทำงานเมื่อมีการเปลี่ยนแปลงวันที่หรือเลือก Ward ใหม่
  - [x] ใช้ logInfo และ logError แทน console.log เพื่อการติดตามปัญหาได้ดีขึ้น
  - [x] ปรับปรุงการคำนวณข้อมูลจำนวนเตียงให้แม่นยำและสอดคล้องกับข้อมูลจริง
...
## รายการงานเร่งด่วนที่ต้องแก้ไข (กรกฎาคม 2024)

- [ ] **ปรับปรุงการแสดงผลบน Mobile Device**
  - [ ] ทดสอบการแสดงผลบน iPhone และ iPad อย่างละเอียด
  - [ ] ปรับหน้า Dashboard ให้แสดงผลได้ดีบนหน้าจอขนาดเล็ก
  - [ ] แก้ไขการแสดงผลกราฟที่ซับซ้อนให้เหมาะกับหน้าจอโมบาย
  - [ ] เพิ่ม Responsive Layout สำหรับหน้าแบบฟอร์มทั้งหมด

- [ ] **พัฒนาระบบ Export ข้อมูลจาก Dashboard**
  - [ ] เพิ่มปุ่ม Export ข้อมูลเป็น Excel/PDF ในตารางสรุป
  - [ ] เพิ่มความสามารถในการบันทึกกราฟเป็นรูปภาพ
  - [ ] พัฒนาระบบรายงานแบบกำหนดเองตามความต้องการของผู้ใช้

- [ ] **ปรับปรุงประสิทธิภาพการโหลดข้อมูล**
  - [ ] เพิ่ม Skeleton Loading State ระหว่างการโหลดข้อมูล
  - [ ] ลด Re-render ที่ไม่จำเป็นในคอมโพเนนต์หลัก
  - [ ] เพิ่ม Data Caching เพื่อลดการเรียกข้อมูลซ้ำ

### รายการที่แก้ไขไป (อัปเดตล่าสุด 2025-05-28)
- [x] กรองไม่ให้แสดงปุ่มเลือก Ward6 ใน `WardCensusButtons.tsx` ตามข้อกำหนดใหม่
